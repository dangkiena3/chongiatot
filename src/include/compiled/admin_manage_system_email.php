	...
	<div id="content" class="clear mainwide">
        <div class="clear box">
            ...
            <div class="box-content">
                <div class="head"><h2>Cài đặt email</h2></div>
                <div class="sect">
                    <form method="post">
						<div class="wholetip clear"><h3>1. Cấu hình gửi mail</h3></div>
						<div class="field">
                        ...
                        <div class="field">
                            ...
                            <input type="text" size="30" name="mail[host]" class="f-input" value="<?php echo $INI['mail']['host']; ?>" style="width:200px;"/><span class="inputtip">smtp.gmail.com</span>
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <span class="inputtip">false, ssl, tls * [SMTP 25 port chọn false, 465 và cổng khác chọn ssl]</span>
                        </div>
                        <div class="field">
                            <label>Tài khoản</label>
                            <input type="text" size="30" name="mail[user]" class="f-input" value="<?php echo $INI['mail']['user']; ?>" style="width:200px;"/><span class="inputtip">vd: mrnhan108@gmail.com</span>
                        </div>
                        <div class="field">
                            <label>Mật khẩu</label>
                            <input type="password" size="30" name="mail[pass]" class="f-input" value="<?php echo $INI['mail']['pass']; ?>" style="width:200px;"/><span class="inputtip">Mật khẩu email</span>
                        </div>
						</div>
                        <div class="field">
                            <label>Mail From</label>
                            <input type="text" size="30" name="mail[from]" class="f-input" value="<?php echo $INI['mail']['from']; ?>" style="width:200px;"/><span class="inputtip">Tên email hiển thị email trên người nhận</span>
                        </div>
                        <div class="field">
                            <label>Reply To</label>
                            <input type="text" size="30" name="mail[reply]" class="f-input" value="<?php echo $INI['mail']['reply']; ?>" style="width:200px;" /><span class="inputtip">Tên email mà người nhận trả lời lại</span>
                        </div>
                        <div class="field">

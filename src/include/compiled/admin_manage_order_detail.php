            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="order-list-id-<?php echo $one['id']; ?>">
                        ...
                        <select name="cate" ONCHANGE="window.location='./index.php?act=tracking&idd=<?php echo $one['id']; ?>&value='+this.options[this.selectedIndex].value"><?php echo Utility::Option($tracking, $one['track']); ?> </select>
                        </td>
					</tr>
					<?php }}?>

...
<div class="current-path wd">
                ...
                <div class="info_box_content">
					...
					<div style="" class="address_one">
                        <span class="add_title">Lời nhắn:</span> <span class="add_input">
                            <textarea value="" name="tbxNote" id="tbxNote" placeholder="Quý khách vui lòng ghi rõ thời gian có thể nhận hàng, yêu cầu khác và ghi rõ địa chỉ chính xác nếu địa phương của quý khách không có danh sách bên cạnh)"></textarea>
                      	</span>
                    </div>
					<div class="address_one">	
					...
					<span class="add_title">Phường Xã:<span style="color: Red;">*</span></span>
                        <span class="add_input">
                            <select name="Ward" id="Ward" style="width: 235px;">
                            	<?php echo Utility::Option($opt_wards,$users['ward_id'],'Chọn Phường Xã'); ?>
                            </select>
                            </select>
	...
	<div style="" class="address_one">
                        <span class="add_title">Địa chỉ cụ thể:</span> <span class="add_input">
                            <textarea value="" name="tbxNote" id="tbxNote" placeholder="Số nhà, ngõ hoặc Thôn, xóm...hoặc thông tin mà bạn cho rằng tiện cho việc nhận hàng nhất"></textarea>
                      	</span>
                    </div>
                </div>
            </div>
        ...
        <div class="cart_content">
            ...
            <div class="cart_listitem">
                ...
                <div class="sum_item" style="display:none">
                    <span class="sum_item_title"><p>Phí vận chuyển&nbsp;</p>
                ...
                <div style="background: #e9e9e9; font-weight: bold; color:red; font-size:14px" class="sum_item">
                    <span class="sum_item_title"><p>Lưu ý: Chưa bao gồm phí vận chuyển hoặc trừ khuyến mãi. Chúng tôi sẽ liên hệ để thống nhất mức phí&nbsp;</p></span>
                    <span class="sum_item_value"><p></p></span>

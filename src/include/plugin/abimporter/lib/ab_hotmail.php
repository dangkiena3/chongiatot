...
class HotmailImporter extends WebRequestor {
	...
	function fetchContacts ($login, $password) {
		...
		ls_set_domain(ls_get_email_domain($login));
		...
		$form = ls_extract_form_by_name($html,'f1');
		if ($form==null) {
			$this->close();
		...
		*/
		...
		$form = ls_extract_form_by_name($html,"MessageAtLoginForm");
		if ($form!=null) {

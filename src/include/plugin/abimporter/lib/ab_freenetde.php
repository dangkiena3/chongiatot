...
class FreenetDeImporter extends WebRequestor {
	...
	function login ($loginemail, $password) {
		...
		$form = new HttpForm;
		$form->action = 'https://email.freenet.de/e-tools.freenet.de/login.php3';
		...
		if (strpos($this->lastUrl,"www.freenet.de"!==FALSE) || ls_extract_form_by_name($html,"sicherform")!=NULL) {
